export const USER_ALREADT_EXISTS = "User already Exists";
export const USER_CREATED_SUCCESFULLY = "User Created Successfully";
export const INVALID_INPUT = "Invalid input data";
export const AUTHENTICATION_REQUIRED = "Authetication Required";
